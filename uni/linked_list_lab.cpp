...
//     const int maxMarks = 100; // Assuming maximum marks value is 100
//     int count[maxMarks + 1] = {0}; // Initialize the array with zeros

//     // Find the maximum marks in the linked list
//     Node *curr = start;
//     while (curr != NULL) {
//         count[curr->marks] = count[curr->marks] + 1;
//         curr = curr->next;
//     }

//     curr = start;
//     int marksIndex = 0;
//     while (marksIndex <= maxMarks) {
//         if (count[marksIndex] > 0) {
//             curr->marks = marksIndex;
//             curr = curr->next;
//             count[marksIndex]= count[marksIndex] - 1;
//         } else {
